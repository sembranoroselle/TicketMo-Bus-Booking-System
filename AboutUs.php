...
.topic_bus{
  ...
  <body>
        ...
        <div class="about-intro">
            ...
            <p>The TicketMo Bus Booking System is designed to automate online ticket purchasing through an easy-to-use online bus booking system. Embed our online bus ticketing system into your website and enable your customers to book tickets for various routes and destinations.</p>
        </div>
    </div>
...
?>
        ...
        <div class="about-intro">
            ...
            <p>Plan your journey ahead of time, save time buying bus tickets, avoid lengthy lines, discover your boarding location quickly, and enjoy your joyous journey in comfort using TicketMo's efficient bus reservation system
            </p>
